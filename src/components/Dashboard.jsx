...
import { deleteExpense, selectTotalBalance, selectTotalExpense, selectTotalIncome } from "../slices/expenseSlice";
...
//   };
  ...
  const recentTransaction = useMemo(() => {
    ...
    fortyEightHourAgo.setHours(fortyEightHourAgo.getHours() - 48);
